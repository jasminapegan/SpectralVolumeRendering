...
// #include ../html/AbsorptionWidget.html
// #include ../html/AbsorptionWidgetBumpHandle.html
// #include ../css/AbsorptionWidget.css

class AbsorptionWidget extends EventEmitter {
...
constructor(options) {
    ...
    this._$html = DOMUtils.instantiate(TEMPLATES.AbsorptionWidget);
    ...
    this._canvas.width = this._absorptionWidth;
    this._canvas.height = this._absorptionnHeight;
    ...
    this._program = WebGL.buildPrograms(gl, {
        drawAbsorption: SHADERS.drawAbsorption
    }, MIXINS).drawAbsorption;
    ...
    this._$saveButton.addEventListener('click', () => {
        CommonUtils.downloadJSON(this._bumps, 'Absorption.json');
    });
}
...
resizeAbsorption(width, height) {
    this._canvas.width = width;
    this._canvas.height = height;
    this._absorptionWidth = width;
    this._absorptionHeight = height;
    const gl = this._gl;
...
_addHandle(index) {
    const $handle = DOMUtils.instantiate(TEMPLATES.AbsorptionWidgetBumpHandle);
