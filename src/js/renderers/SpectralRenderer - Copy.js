...
constructor(gl, volume, environmentTexture, options) {
    ...
    this._programs = WebGL.buildPrograms(gl, {
        generate  : SHADERS.SpectralGenerate,
        integrate : SHADERS.SpectralIntegrate,
        render    : SHADERS.SpectralRender,
        reset     : SHADERS.SpectralReset
    }, MIXINS);
}
...
_integrateFrame() {
    ...
    gl.uniform1i(program.uniforms.uAbsorption, 7);
